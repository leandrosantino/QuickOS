/*
  ...
  - Added the required column `actionsUniqueKey` to the `PreventiveOS` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "PreventiveOS_actionsUniqueKey_key" ON "PreventiveOS"("actionsUniqueKey");
