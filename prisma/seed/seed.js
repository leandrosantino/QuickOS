...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var worker, m42, actions, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, exports.prisma.worker.create({
                        data: {
                            name: "Robert",
                            registration: 15,
                            "class": "Mecânico"
                ...
                case 1:
                    worker = _b.sent();
                    return [4 /*yield*/, exports.prisma.machine.create({
                            data: {
                                tag: "M42",
                                technology: "WaterJet",
                                ute: "UTE-5"
                ...
                case 2:
                    m42 = _b.sent();
                    return [4 /*yield*/, exports.prisma.preventiveAction.create({
                            data: {
                                machineId: m42.id,
                ...
                case 5:
                    ...
                    return [4 /*yield*/, exports.prisma.preventiveOS.create({
                            data: {
                                machineId: m42.id,
